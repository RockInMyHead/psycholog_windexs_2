...
async function seedQuotes() {
  ...
  const defaultQuotes = [
    ...
    { text: "«Стремитесь не к успеху, а к ценности».", author: "Альберт Эйнштейн", category: "Ценности" },
    { text: "«Вера в себя — первый секрет успеха».", author: "Ральф Эмерсон", category: "Самоценность" },
    { text: "«Мы становимся тем, о чём думаем».", author: "Будда", category: "Осознанность" },
    { text: "«Дисциплина — мост между целями и достижениями».", author: "Джим Рон", category: "Дисциплина" },
    { text: "«Если нет ветра — беритесь за вёсла».", author: "Латинская пословица", category: "Действие" },
    { text: "«Сначала делайте необходимое, затем возможное — и вдруг увидите, что совершаете невозможное».", author: "Франциск Ассизский", category: "Вера" },
    { text: "«Неудача — это возможность начать снова, но уже мудрее».", author: "Генри Форд", category: "Настойчивость" },
    { text: "«Выберите работу по душе — и вам не придётся работать ни дня».", author: "Конфуций", category: "Труд" },
    { text: "«Кто хочет видеть радугу, должен переждать дождь».", author: "Долли Партон", category: "Надежда" },
    { text: "«Пессимист видит трудность в каждой возможности, оптимист — возможность в каждой трудности».", author: "Уинстон Черчилль", category: "Оптимизм" },
    { text: "«Не позволяйте шуму чужих мнений заглушить ваш внутренний голос».", author: "Стив Джобс", category: "Аутентичность" },
    { text: "«Будущее зависит от того, что вы делаете сегодня».", author: "Махатма Ганди", category: "Действие" },
    { text: "«Характер проявляется там, где нет свидетелей».", author: "Неизвестный автор", category: "Характер" },
    { text: "«Тишина — источник огромной силы».", author: "Лао-цзы", category: "Осознанность" },
    { text: "«Сомнения убивают больше мечтаний, чем неудачи».", author: "Сьюзи Кассен", category: "Смелость" },
    { text: "«Чем труднее борьба, тем слаще победа».", author: "Лес Браун", category: "Стойкость" },
    { text: "«Никогда не отказывайся от цели из-за времени — оно всё равно пройдёт».", author: "Неизвестный автор", category: "Настойчивость" },
    { text: "«Если ты хочешь подняться, подними кого-нибудь другого».", author: "Букер Т. Вашингтон", category: "Поддержка" },
    { text: "«Терпение — это не пассивное ожидание, а концентрация силы».", author: "Брюс Ли", category: "Терпение" }
  ];
