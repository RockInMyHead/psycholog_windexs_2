...
Модуль оплаты с интеграцией ЮKassa для Node.js приложений. Поддерживает подписки, разовые платежи и управление доступом к контенту.
...
const hasAccess = await paymentService.checkUserAccess('user123', 'audio_sessions');
```
